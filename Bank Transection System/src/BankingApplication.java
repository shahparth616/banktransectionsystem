...
public class BankingApplication {
    ...
    BankingOperationsImp bankingOperationsImp = new BankingOperationsImp();
    ...
    private void addList() throws  SQLException{
        ...
        int recordsAdded = accountOperationsImp.addAccounts(a);

        System.out.println(recordsAdded+ " new accounts are added into the System!");
    }
